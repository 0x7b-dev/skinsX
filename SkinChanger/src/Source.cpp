...
*/
#define m_dwLocalPlayer 0xCD2764
#define m_dwEntityList 0x4CE34DC
...
int main()
{
	...
	if (count)
	{
		...
		DWORD knifeID = skinsSelect("Select your knife model:", (char**)knifeNames, sizeof(knifeIDs) / sizeof(knifeIDs[0]) - 1);
		printf("\n");
